...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 mx-auto w-full max-w-lg md:max-w-3xl border-t-2 border-line bg-card pb-[max(0.5rem,env(safe-area-inset-bottom))]">
